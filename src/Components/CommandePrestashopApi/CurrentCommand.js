...
class CurrentCommand extends React.Component{
    ...
    state = {
      ...
      render() {
        ...
        return <Table columns={columns} dataSource={this.props.auth.current_command} style={{overflow:"scroll", width:"100%"}} />;
      }
    }
...
export default connect (mapStateToProps, mapDispatchToProps)(CurrentCommand)